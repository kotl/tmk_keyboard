...
{ KC_FN1,KC_G,KC_F,KC_D,KC_S,KC_A,KC_FN3,KC_NO},  \
...
{ KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_FN0,KC_TRNS,KC_TRNS},  \
{ KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_NO,KC_TRNS,KC_TRNS,KC_TRNS},  \
{ KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_NO,KC_TRNS,KC_TRNS,KC_TRNS},  \
{ KC_VOLD,KC_FN4, KC_FN5, KC_TRNS, KC_FN6, KC_NO, KC_FN7,KC_VOLU},  \
{ KC_F5,KC_F4,KC_F3,KC_F2,KC_F1,KC_TRNS,KC_FN2,KC_TRNS},  \
{ KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_NO},  \
{ KC_FN1,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_NO},  \
{ KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_NO},  \
{ KC_NO,KC_FN8, KC_TRNS, KC_FN9, KC_FN10,KC_TRNS,KC_TRNS,KC_TRNS}  \
},  
[2] = { \
...
static const uint16_t PROGMEM fn_actions[] = {
  ACTION_LAYER_MOMENTARY(2),      // KC_FN0
  ACTION_LAYER_MOMENTARY(2),      // KC_FN1
  ACTION_LAYER_TAP_TOGGLE(1),      // KC_FN2
  ACTION_MODS_KEY(MOD_LALT, KC_LSFT), // KC_FN3
  ACTION_MODS_KEY(MOD_LCTL, KC_PGDOWN), // KC_FN4
  ACTION_MODS_KEY(MOD_LCTL, KC_T),                 // KC_FN5
  ACTION_MODS_KEY(MOD_LCTL, KC_W),   //KC_FN6
  ACTION_MODS_KEY(MOD_LCTL, KC_PGUP),  // KC_FN7
  ACTION_MODS_KEY(MOD_LALT|MOD_LSFT, KC_TAB), // KC_FN8
  ACTION_MODS_KEY(MOD_LALT, KC_F4), // KC_FN9
  ACTION_MODS_KEY(MOD_LALT, KC_TAB) // KC_FN10
};
